                ...
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <a href="/home" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Back to home</span></a>						
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        <c:forEach items="${listP}" var="o">
                            <tr>
                                ...
                                <td>${o.price} đ</td>
                                <td>
                                    <a href="loadBook?pid=${o.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
